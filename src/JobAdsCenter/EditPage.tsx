...
<div className="col-12">    <ProfileLoader  width ={150} height={100} fontSize={"12px"} fontWeight={"600"}  Title={"Please Wait!"}/>     </div>}   
                    ...
                    <div className="col-12 d-grid mt-1">
                        ...
                        {
                          onClickChangeArea ?
                      <div className="jobCardContentScroll p-1" style={{height:"250px"}} onClick={()=>{setOnclickChangeArea(false)}}>
  ...
  onEditorStateChange={newState => {
    ...
    setAddData({...addData,adDescription:draftToHtml(convertToRaw(newState.getCurrentContent()))})
}}
/>
}
</div>
