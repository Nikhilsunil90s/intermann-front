        ...
        <div className="container-fluid bg-white headerBoxInBilling">
          <div className="row p-1 ">
            ...
            <div className="col-4 d-flex justify-content-end">
              <Link
                className="btnHeaderInvoice"
                to={"/billing-Center/AddInvoice"}
              >
                Create New Invoice{" "}
              </Link>
            </div>
          ...
          <div className="row p-1 justify-content-center align-items-center">
            <div className="col-8 d-flex justify-content-center">
              <button
                ...
                className={`mx-1 ${
                  activeTab == "All" ? "ActiveTabs_22s" : "ActiveTabs_22"
                }`}
              >
                All
              </button>
              <button
                ...
                className={`mx-1 ${
                  activeTab == "Paid" ? "ActiveTabs_22s" : "ActiveTabs_22"
                }`}
              >
                Paid
              </button>
              <button
                ...
                className={`mx-1 ${
                  activeTab == "Unpaid" ? "ActiveTabs_22s" : "ActiveTabs_22"
                }`}
              >
                Unpaid
              </button>
