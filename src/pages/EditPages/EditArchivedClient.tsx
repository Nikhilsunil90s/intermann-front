...
function ClientArchivedEdit() {
    ...
    const notifyClientEditSuccess = () => toast.success("Client Updated Successfully! View Client in  Clients/Leads List.");
...
<div className="container-fluid">
         ...
         <div className="row">
          ...
          <div className="col-4 d-flex align-items-center justify-content-end">
            <Link to={path}>
          <button className="btn bg-ClientCancel" type="button" style={{padding:"8px"}}>
                                    <img
                                        style={{ width: "25%" }}
                                    ...
                                    <div className="col-5 card-xl">
                                        <div className="row">
                                            ...
                                            <div className="col-12 pt-2">
                                                ...
                                                <input name="numberOfPosts" placeholder="Num Only" className="form-control" defaultValue={profile.numberOfPosts}  onChange={onFormDataChange} />
                                            </div>
                                        </div>
                                    </div>
