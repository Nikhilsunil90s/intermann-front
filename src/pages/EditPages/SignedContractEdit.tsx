...
function ClientSignedEdit() {
  const notifyClientEditSuccess = () =>
    toast.success(
      "Client Updated Successfully! View Client in Signed Clients/Leads List."
    );
  ...
  const notifyPhotoUploadSuccess = () =>
    toast.success("Client/Company Image Uploaded Successfully!");

  const notifyPhotoUploadError = () =>
    toast.error("Cannot Upload Client/Company Image! Please Try Again.");
  ...
  const addLanguages = (lang: string) => {
    ...
    setData((prev) => ({
      ...prev,
      ["clientLanguages"]: [...selectedLanguages, lang],
    }));
  };
  ...
  const removeLanguages = (lang: string) => {
    ...
    setData((prev) => ({
      ...prev,
      ["clientLanguages"]: [...selectedLanguages.filter((l) => l !== lang)],
    }));
  };
      ...
      updateClient(formdata)
        .then((response) => {
          ...
          if (response.status) {
            ...
            setTimeout(() => {
              navigate("/clientContract/clientSigned");
            }, 2000);
          }
        })
        .catch((err) => {
        ...
        <div className="row">
          <form className="form px-0" onSubmit={onFormSubmit}>
            ...
            <div className="">
              ...
              <div className="col-12 Social-CardClient my-1 p-1 mb-2">
                <div className="row">
                  <div className="col-4">
                        ...
                        {profile.clientContract ? (
                          ...
                          <div className="col-12 d-flex justify-content-center align-items-center py-2">
                            ...
                            <p className="mb-0 ErrorSearchBox">
                              No Contract Available for this Signed Client!
