...
function EditDo() {
  ...
  const [candidatImage, setCandidatImage] = useState(
    profile.candidatPhoto ? profile.candidatPhoto.url : ""
  ) as any;
  ...
  const notifyCandidatEditSuccess = () =>
    toast.success(
      "Candidat Updated Successfully! View Candidat in To-Do List."
    );
            ...
            <div className="mt-1">
              <div className="col-12  p-1 bg-colorForEdit">
                <div className="row">
                  ...
                  <div
                    className="col-xxl-3 col-xl-3 col-lg-3 col-md-4 d-flex align-items-center  text-end end-class"
