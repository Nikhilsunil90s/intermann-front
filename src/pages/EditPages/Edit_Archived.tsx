...
function EditArchive() {
  ...
  const [reasonArchived, setReasonArchived] = useState(
    profile.candidatArchived.reason
  );
  ...
  const notifyCandidatEditSuccess = () =>
    toast.success(
      "Candidat Updated Successfully! View Candidat in Archived List."
    );
  ...
  const onFormDataChange = (
    ...
    if (e.target.name === "reasonArchived") {
      ...
      setData((prev) => ({
        ...prev,
        ["candidatArchived"]: { reason: e.target.value },
      }));
      return;
    }
  ...
  const onFormSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (formTouched) {
      const updatedData = {
        ...
        candidatArchived:
          data.candidatArchived.reason != ""
            ? data.candidatArchived
            : profile.candidatArchived,
        candidatAlternatePhone:
  ...
  useEffect(() => {
    ...
    if (
      ...
      fetchAllJobs(
        selectedSector !== "" ? selectedSector : profile.candidatActivitySector
      )
        .then((data) => {
          setJobs([...data.data]);
        })
              ...
              <div className="col-12  p-1 bg-colorForEdit">
                <div className="row">
                  <div className="col-2 text-center ">
                    {candidatImage !== "" ? (
                      <img
                        alt="..." // src={require("../images/menlogos.svg").default}
                        src={candidatImage}
                    ...
                    <div className="row">
                      <div className="col-12">
                        ...
                        <input
                          ...
                          className="form-control widthInputField"
                          name="candidatName"
                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-5 px-0 text-end end-class align-items-center justify-content-end pt-1 pr-2">
                    ...
                    <p className="text-PREBtn-child pb-1">
                      This candidate have archived
                    </p>
                  </div>
                </div>
              </div>
