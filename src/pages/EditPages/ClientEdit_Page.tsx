...
function ClientTodoEdit() {
  const notifyClientEditSuccess = () =>
    toast.success(
      "Client Updated Successfully! View Client in To-Do Clients/Leads List."
    );
              ...
              <div className="row">
                ...
                <div className="col-4 d-flex align-items-center justify-content-end">
                  <Link to={path} style={{ textDecoration: "none" }}>
                    <button className="btn bg-ClientCancel" type="button">
                      <img
                        style={{ width: "25%" }}
                        ...
                        {profile.clientContract ? (
                          ...
                          <div className="col-12 d-flex justify-content-center align-items-center py-2">
                            ...
                            <p className="mb-0 ErrorSearchBox">
                              No Contract Available for this To-Do Client!
