          ...
          <div className="col-12 vw-UserBox">
            <div className="row">
              ...
              <div className="col-12 bg-ListOfUsers pt-1">
                              ...
                              {el.emailAddress ? (
                                <p className="A0012">
                                  {el.username
                                    ...
                                    : null}{" "}
                                  Email:‎ {el.emailAddress} ‎ -‎ Password:‎
                                  ........
                                </p>
                              ) : (
                ...
                {EditModal ? <EditUserModal closeModal={setEditModal} /> : null}
                {deleteModal ? (
                ...
                {/* } */}
                {AddModal ? <UserAddModal closeModal={setAddModal} /> : null}
              </div>
            </div>
          </div>
        </div>
