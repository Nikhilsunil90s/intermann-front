        ...
        <div className="row">
          ...
          <div className="bg-class">
            ...
            <div className="col-12 pt-4">
              ...
              <div className="col-12 edit-Ground">
                <div className="row">
                  <div className="col-6">
                    <p className="Arial">Current employer</p>
                    <div className="dropdown">
                      <div aria-labelledby="dropdownMenuButton1">
                        <select style={{ width: "320px", height: "30px" }}>
                          <option className="child">
                    ...
                    <label className="child-label">Please select the client with who &#10100;candidate_name&#10101; is working with</label>
                  </div>
                  <div className="col-6">
                    <p className="Arial">Current Salary</p>
                  ...
                  <div className="col-6 flex-grid">
                    <label>From date / A PARTIR DE </label>
                    <input placeholder="{CURRENT STATE}" />
                    <p className="child-label">Since when this candidates is working with us</p>
                  </div>
                </div>
              </div>
              <div className="col-12">
