...
function EditProgress() {
  ...
  const [candidatMotivation, setCandidatMotivation] = useState(
  ...
  const [workExperience, setWorkExperience] = useState(
    profile.candidatExperienceDetails.length > 0
      ? [...profile.candidatExperienceDetails]
      : []
  );
  ...
  const notifyCandidatEditSuccess = () =>
    toast.success(
      "Candidat Updated Successfully! View Candidat in In-Progress List."
    );

  const notifyCandidatEditError = () =>
    toast.error("Cannot Edit Candidat! Please Try Again.");

  const notifyCandidatUntouched = () =>
    ...
    if (
      ...
      if (profile.candidatContract !== null) {
        if (profile.candidatContract.contract_date) {
          ...
          setcontract_date(
            [tempdate.getFullYear(), "0" + GetMonth, tempdate.getDate()].join(
              "-"
            )
          );
        }
  ...
  const addLanguages = (lang: string) => {
    ...
    setData((prev) => ({
      ...prev,
      ["candidatLanguages"]: [...selectedLanguages, lang],
    }));
  };
  ...
  const removeLanguages = (lang: string) => {
    ...
    setData((prev) => ({
      ...prev,
      ["candidatLanguages"]: [...selectedLanguages.filter((l) => l !== lang)],
    }));
  };
  ...
  const onFormDataChange = (
    ...
    if (e.target.name === "candidatPhone2") {
      if (e.target.value) {
        setData((prev) => ({
          ...prev,
          ["candidatAlternatePhone"]: e.target.value,
        }));
        return;
      }
    }
  ...
  const onFormSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (formTouched) {
      const updatedData = {
        ...
        candidatName:
          data.candidatName != "" ? data.candidatName : profile.candidatName,
        candidatAge:
          data.candidatAge != 0 ? data.candidatAge : profile.candidatAge,
        candidatMotivation:
          data.candidatMotivation != 0
            ? data.candidatMotivation
            : profile.candidatMotivation,
        candidatActivitySector:
          selectedSector != ""
            ? selectedSector
        ...
        candidatJob:
          data.candidatJob != "" ? data.candidatJob : profile.candidatJob,
        candidatLanguages:
          data.candidatLanguages.length > 0
            ? data.candidatLanguages
            : profile.candidatLanguages,
        candidatStartDate:
          data.candidatStartDate != ""
            ? data.candidatStartDate
            : profile.candidatStartDate,
        candidatEndDate:
          data.candidatEndDate != ""
            ? data.candidatEndDate
            : profile.candidatEndDate,
        ...
        candidatEmail:
          data.candidatEmail != "" ? data.candidatEmail : profile.candidatEmail,
        candidatPhone:
          data.candidatPhone != "" ? data.candidatPhone : profile.candidatPhone,
        candidatAddress:
          data.candidatAddress != ""
            ? data.candidatAddress
            : profile.candidatAddress,
        candidatFBURL:
          data.candidatFBURL != "" ? data.candidatFBURL : profile.candidatFBURL,
        candidatAlternatePhone:
          data.candidatAlternatePhone != ""
            ? data.candidatAlternatePhone
            : profile.candidatAlternatePhone,
        candidatYearsExperience:
          data.candidatYearsExperience != ""
            ? data.candidatYearsExperience
            : profile.candidatYearsExperience,
        candidatCurrentWork: [
          {
            workingFor:
              data.candidatCurrentWork[0].workingFor != ""
                ? data.candidatCurrentWork[0].workingFor
                : workingFor,
            workingSince:
              data.candidatCurrentWork[0].workingSince != ""
                ? data.candidatCurrentWork[0].workingSince
                : workingSince,
            salary:
              data.candidatCurrentWork[0].salary != ""
                ? data.candidatCurrentWork[0].salary
                : salary,
          },
        ],
        lieu_mission:
          data.lieu_mission != ""
            ...
            ? profile.candidatContract.lieu_mission
            : "",
        duree_mission:
          data.duree_mission != ""
            ? data.duree_mission
            : profile.candidatContract
            ? profile.candidatContract.duree_mission
            : "",
        duree_hebdomadaire_mission:
          data.duree_hebdomadaire_mission != ""
            ? data.duree_hebdomadaire_mission
            : profile.candidatContract
            ? profile.candidatContract.duree_hebdomadaire_mission
            : "",
        cmp_candidat:
          data.cmp_candidat != ""
            ? data.cmp_candidat
        ...
        company_contact_name:
          data.company_contact_name != ""
            ? data.company_contact_name
            : profile.candidatContract
            ? profile.candidatContract.company_contact_name
            : "",
        nr_inreg:
          data.nr_inreg != ""
            ? data.nr_inreg
            : profile.candidatContract
            ? profile.candidatContract.nr_inreg
            : "",
        serie_id:
          data.serie_id != ""
            ? data.serie_id
            : profile.candidatContract
            ? profile.candidatContract.serie_id
            : "",
        company_siret:
          data.company_siret != ""
            ? data.company_siret
            : profile.candidatContract
            ? profile.candidatContract.company_siret
            : "",
        companyAddress:
          data.companyAddress != ""
            ? data.companyAddress
            ...
            : "",
        numeroTFCandidat:
          data.numeroTFCandidat != ""
            ? data.numeroTFCandidat
            : profile.candidatContract
            ? profile.candidatContract.numeroTFCandidat
            : "",
        companyVat:
          data.companyVat != ""
            ? data.companyVat
            : profile.candidatContract
            ? profile.candidatContract.companyVat
            : "",
        salaireBrut:
          data.salaireBrut != ""
            ? data.salaireBrut
            : profile.candidatContract
            ? profile.candidatContract.salaireBrut
            : "",
        salaireNet:
          data.salaireNet != ""
            ? data.salaireNet
            : profile.candidatContract
            ? profile.candidatContract.salaireNet
            : "",
        diurnaTotalParJour:
          data.diurnaTotalParJour != ""
            ? data.diurnaTotalParJour
            : profile.candidatContract
        ...
        heurePerSemaine:
          data.heurePerSemaine != ""
            ? data.heurePerSemaine
            : profile.candidatContract
            ? profile.candidatContract.heurePerSemaine
            : "",
        duree_hebdomadaire:
          data.duree_hebdomadaire != ""
            ? data.duree_hebdomadaire
            : profile.candidatContract
            ? profile.candidatContract.duree_hebdomadaire
            : "",
        indemnisationJour:
          data.indemnisationJour != ""
            ? data.indemnisationJour
            : profile.candidatContract
            ? profile.candidatContract.indemnisationJour
            : "",
        fin_mision:
          data.fin_mision != ""
            ? data.fin_mision
        ...
        bankName_euro:
          data.bankName_euro !== ""
            ? data.bankName_euro
            : profile.bankName_euro
            ? profile.bankName_euro
            : "",
        iban_ron_lei:
          data.iban_ron_lei !== ""
            ? data.iban_ron_lei
            : profile.iban_ron_lei
            ? profile.iban_ron_lei
            : "",
        bankName_lei:
          data.bankName_lei !== ""
            ? data.bankName_lei
            : profile.bankName_lei
            ? profile.bankName_lei
            : "",
      };
  ...
  useEffect(() => {
    ...
    if (data.candidatLanguages.length == 0) {
      setData((prev) => ({
        ...prev,
        ["candidatLanguages"]: selectedLanguages,
      }));
    }
          ...
          ["candidatExperienceDetails"]: [
            {
              ...
              workDoneSample: detail.workDoneSample,
            },
          ],
        }));
      });
                ...
                <div className="col-6  d-flex align-items-center">
                  <Link to="/embauchlist/embauchprofile">
                    ...
                    >
                      ...
                      />
                      <h2 className="card-Leads mb-0 pl-1">
                        {" "}
                        Edit File : {profile.candidatName}
                      </h2>
                    </button>
                  </Link>
                </div>
                  ...
                  <div className="col-6 card-xl">
                    <div className="row">
                      <div className="col-12">
                        ...
                        <input
                          style={{ width: "71%" }}
                          defaultValue={profile.candidatName}
                      ...
                      <div className="col-12 pt-2">
                        ...
                        <input
                          style={{ width: "71%" }}
                          defaultValue={profile.candidatAge}
                          name="candidatAge"
                          className="form-control"
                          onChange={onFormDataChange}
                        />
                      ...
                      <div className="text-end">
                        <button className="InProLargebtn">
                          <img
                            alt="..."
                            src={
                              require("../../images/thundermini.svg").default
                            }
                          />
                          IN PROGRESS
                        </button>
              ...
              <div className="col-12 mt-1 px-1 p mb-2">
                <div className="row bg-colorForEdit pt-1 px-1 pb-1">
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    ...
                    <div className="dropdown">
                      ...
                      <Select
                        ...
                        defaultValue={{
                          label: profile.candidatActivitySector,
                          value: profile.candidatActivitySector,
                          color: "#FE8700",
                        }}
                        styles={colourStyles}
                    ...
                    <div className="dropdown">
                      <div aria-labelledby="dropdownMenuButton1">
                        ...
                        <Select
                          ...
                          classNamePrefix="select"
                          defaultValue={{
                            label: profile.candidatJob,
                            value: profile.candidatJob,
                            color: "#FE8700",
                          }}
                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 ">
                    ...
                    <input
                      placeholder="Candidat Email"
                      className="form-control"
                      name="candidatEmail"
                      defaultValue={profile.candidatEmail}
                      onChange={onFormDataChange}
                    />
                  </div>
                  ...
                  <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-5 px-0 mt-3">
                    <div className="d-flex">
                      <label className="Permis ">Permis / Licence drive</label>
                      <span>
                        {" "}
                        <Switch
                          className=""
                  ...
                  <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-7  pr-0  mt-3">
                    <div className="d-flex">
                      <label className="Permis" style={{ width: "64%" }}>
                    ...
                    <div className="row">
                      ...
                      <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5 mt-2">
                        <label className="LabelStylingEdits">
                          {" "}
                          Candidat phone number
                        </label>
                        <input
                          placeholder="Candidat Phone"
                          className="form-control"
                          name="candidatPhone"
                          defaultValue={profile.candidatPhone}
                          onChange={onFormDataChange}
                        />
                      ...
                      <div className="col-xxl-7 col-xl-7 col-lg-7 col-md-7 mt-2">
                        ...
                        <div className="">
                          <Select
                            ...
                            styles={colourStyles}
                            defaultValue={profile.candidatLanguages.map(
                              (el) => {
                                return {
                                  value: el,
                                  label: el,
                      ...
                      <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 mt-1">
                        <label className="LabelStylingEdits">
                          Candidat phone number 2
                        </label>
                        <input
                          placeholder="Candidat Phone Number"
                          className="form-control"
                          name="candidatPhone2"
                          defaultValue={profile.candidatAlternatePhone}
                          onChange={onFormDataChange}
                        />
                        <p className="child-label">Use international format</p>
                      </div>
                      <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 mt-1">
                        ...
                        <input
                          placeholder="Candidat Facebook Profile"
                          className="form-control"
                          name="candidatFBURL"
                          defaultValue={profile.candidatFBURL}
                          onChange={onFormDataChange}
                        />
                      </div>
                      <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 mt-1 ">
                        <label className="LabelStylingEdits">
                          {" "}
                          Candidat Experience in Years
                        </label>
                        <input
                          placeholder="Number only"
                          className="form-control"
                          name="candidatYearsExperience"
                          defaultValue={profile.candidatYearsExperience}
                          onChange={onFormDataChange}
                        />
                      </div>
                    </div>
                  ...
                  <div className="col-12 mt-1">
                    <h3 className="Expérience">
                      Expérience du Candidat (fill only lines, higher = more
                      recent)
                    </h3>
                        ...
                        {workExperience.length > 0 ? (
                          ...
                          <tr>
                            <td colSpan={3} className="text-center">
                              ...
                              >
                                Click to Add Candidat Experience Details!
                              </button>
                            </td>
                          </tr>
                        )}
                  ...
                  <div className="col-12 editInprogressGround">
                    <div className="row">
                      <div className="col-5">
                              ...
                              {clients.length > 0 ? (
                                clients.map((client) => (
                                  <option
                                    ...
                                    selected={
                                      profile.candidatCurrentWork[0]
                                        .workingFor == client.clientCompanyName
                                    }
                                  >
                        ...
                        <label className="shortNote">
                          Please select the client with whom{" "}
                          {profile.candidatName} is working with.
                        </label>
                      </div>
                      <div className="col-6">
              ...
              <div className="row p-1">
                <div className="col-4">
                  ...
                  <input
                    ...
                    defaultValue={profile.iban_euro ? profile.iban_euro : ""}
                    name="iban_euro"
                    onChange={onFormDataChange}
                ...
                <div className="col-4">
                  ...
                  <input
                    className="form-control inputStylingForView"
                    defaultValue={
                      profile.bankName_euro ? profile.bankName_euro : ""
                    }
                    name="bankName_euro"
                    onChange={onFormDataChange}
                ...
                <div className="col-4">
                  ...
                  <input
                    className="form-control inputStylingForView"
                    defaultValue={
                      profile.bankName_lei ? profile.bankName_lei : ""
                    }
                    name="bankName_lei"
                    onChange={onFormDataChange}
                  ...
                  <>
                    ...
                    <div className="col-4  d-grid ">
                      ...
                      <input
                        ...
                        name="duree_mission"
                        onChange={onFormDataChange}
                        placeholder="‎ ‎ ‎ Durée_Mission"
                      />
                    </div>
                    <div className="col-4  d-grid ">
                      <label className="PDFFormlabel">
                        Durée Hebdomadaire Mission
                      </label>
                      <input
                        className="form-control inputStyling"
                        defaultValue={
                        ...
                        name="duree_hebdomadaire_mission"
                        onChange={onFormDataChange}
                        placeholder="‎ ‎ ‎ Durée_Hebdomadaire_Mission"
                      />
                    </div>
                    <div className="col-4  d-grid ">
                      ...
                      <input
                        ...
                        defaultValue={
                          profile.candidatContract
                            ? profile.candidatContract.candidatJob != ""
                              ? profile.candidatContract.candidatJob
                              : ""
                            : ""
                        }
                    ...
                    <div className="col-4  d-grid ">
                      ...
                      <input
                        className="inputStylings wHCompany form-control"
                        defaultValue={
                          profile.candidatContract
                            ? profile.candidatContract.company_contact_name !=
                              ""
                    ...
                    <div className="col-4  d-grid ">
                      ...
                      <input
                        ...
                        defaultValue={
                          profile.candidatContract
                            ? profile.candidatContract.candidatAddress !== ""
                              ? profile.candidatContract.candidatAddress
                              : ""
                            : ""
                        }
                        placeholder="‎ ‎ ‎ Candidate_Adress"
                      />
                    </div>
                    <div className="col-4  d-grid ">
                    ...
                    <div className="col-4  d-grid ">
                      ...
                      <input
                        ...
                        onChange={onFormDataChange}
                        placeholder="‎ ‎ ‎ Numero TF Candidat"
                      />
                    </div>
                    <div className="col-4  d-grid ">
                    ...
                    <div className="col-4  d-grid ">
                      ...
                      <input
                        ...
                        placeholder="‎ ‎ ‎ Salaire_Net"
                      />
                    </div>
                    <div className="col-4  d-grid ">
                      <label className="PDFFormlabel">
                        Diurna Total Par Jour
                      </label>
                      <input
                        className="form-control inputStyling"
                        ...
                        placeholder="‎ ‎ ‎ Diurna Total Par Jour"
                      />
                    </div>
                    <div className="col-4  d-grid ">
                      <label className="PDFFormlabel">
                    ...
                    <div className="col-4  d-grid ">
                      ...
                      <input
                        ...
                        placeholder="‎ ‎ ‎ Duree Hebdomadaire"
                      />
                    </div>
                    <div className="col-4  d-grid ">
