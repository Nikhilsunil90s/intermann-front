...
function PreSelectedEdit() {
  ...
  const notifyCandidatEditSuccess = () =>
    toast.success(
      "Candidat Updated Successfully! View Candidat in PRE-SELECTED List."
    );
                      ...
                      <div className="text-end">
                        <button className="preLargebtn">
                          <img
                            alt="..."
                            src={
                              require("../../images/preselectedCard.svg")
                                .default
                            }
                          />
                          PRE SELECTED
                        ...
                        {JSON.stringify(profile).includes(
                          ...
                          <div className="col-12 d-flex justify-content-center pt-2">
                            ...
                            <p className="mb-0 ErrorSearchBox">
                              No Contract Available for this Candidat! Please
                              add a New Contract.
                            </p>
                          </div>
                        )}
                        <div className="col-12 px-0 mt-3">
                          <div className="row justify-content-end">
                            <div className="col-6 d-flex justify-content-end">
                              ...
                              <button
                                className="btn editBtnSave mb-0"
                                type="submit"
                              >
                                <img
                                  alt="..."
                                  ...
                                  src={
                                    require("../../images/savebtn.svg").default
                                  }
                                />
                                Save Profile
                              </button>
