      ...
      <div className="card cardInPro p-0 HoveRESTClassCardIn">
        <div className="d-flex cursor-pointer" onClick={viewFullProfile}>
            ...
            <div>
              ...
              >
                ...
                <b
                  ...
                  style={{ width: "37%", marginLeft: "3px", height: "43px" }}
                >
          ...
          <div className="col-3 px-0 d-flex align-items-center">
            <button className="progressCardBtnClient">
        ...
        <div className="col-12 d-flex align-items-center colorRecruting my-1 ">
          <p
            className="in-Recruting mb-0 "
            style={{
              color: date >= start && date < end ? "#A461D8" : "#ca1313",
            }}
          >
            Recruiting :{" "}
            {date >= start && date < end
        ...
        <div className="Ads-box p-1">
          <div className="">
            ...
            <p className="AdsFont mb-0">
              Num of position found :{" "}
              {props.data.numberOfPosts ? props.data.numberOfPosts : "0"}/5
            </p>
            <div className="col-12">
