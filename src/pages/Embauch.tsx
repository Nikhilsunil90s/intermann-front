...
function Embauch() {
  ...
  const filterFunction = async () => {
    ...
    if (LicencePermisArr.length > 0) {
      ...
      setLoaderTime(false);
      fetch(
        `${API_BASE_URL}getCandidats/?candidatLicensePermis=${LicencePermisArr}&candidatStatus=In-Progress`,
        {
          method: "GET",
          headers: {
            Accept: "application/json",
  ...
  return (
    <>
      ...
      />
      <div
        className="container-fluid mt-1 cardScrollBar"
        onScroll={loadMoreHandle}
        style={{ overflow: "auto", height: "100vh" }}
      >
        <div className="row pd">
          <div
            className="col-12 card-tops px-1 mt-1"
          ...
          >
            <div className="row text-start">
              ...
              >
                <div className="">
                  <h1 className="fontStylingEmbauche">
                    Candidats / Employes <span>Embauché / In Progress</span>
                  </h1>
                  ...
                  <div className="col-12">
                    <div className="row justify-content-end">
                      <div className="col-2 d-flex justify-content-end">
                        ...
                        HaveName !== null ? (
                          <p
                            className="filterStyling  cursor-pointer HoveRESTClass mt-2"
                            onClick={() => RestFilters()}
                          >
                            Reset Filters
                          </p>
                ...
                filterData.length > 0 ? (
                  filterData.map((profile, index) => (
                    <motion.div
                      ...
                      className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-1  pr-0"
                      key={index}
                    >
                      <EmbaucheProfileCard
                        path={false}
