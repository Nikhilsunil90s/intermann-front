    ...
    <>
      ...
      <div className="container-fluid " style={{ marginTop: "80px" }}>
        <div className="row px-1">
          <div className="card mt-2 marginTopCard mb-0">
          ...
          <div className="col-12 mt-2">
            <div className="row boxArchivedProfile">
              <div className="whyFont">
                <p>
                  WHY THIS CANDIDATES HAVE BEEN ARCHIVED:{" "}
                  <span> {profile?.candidatArchived?.reason}</span>
                </p>
              </div>
            </div>
          </div>
