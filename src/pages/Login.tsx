            ...
            <div className="row" style={{ height: "100vh" }}>
              <div className="col-6 px-0">
                <div className="img-Back d-flex justify-content-center align-items-center">
                  <div className="d-flex bottom-radius  justify-content-center align-items-center text-decoration-none">
                    <img
                      alt="..."
                      className="TopStickClass"
                      src={require("../images/LoginStick.svg").default}
                    />
                    <span>
                      <img
                        alt="..."
                ...
                <div className=" d-flex justify-content-end">
                  ...
                  >
                    <div className="HeaderModalSelect">
                      <img
                        alt="..."
                        src={require("../images/headerSelect.svg").default}
                      />
                    </div>
                    ...
                    {ModalOpen ? (
                      <div
                        className="modal d-flex LoginModalContainer"
                        ref={ref}
                        ...
                        <div className="modal-dialog HeaderWidthModal">
                          <div className="modal-content">
                            <div className="modal-body HeaderWidthModal text-start">
                              ...
                              >
                                <p className="VoirLESite mb-0 ml-1">
                  ...
                  <form className="login-panel" onSubmit={onLoginFormSubmit}>
                    <div className="text-center">
                      ...
                      <p className="lost-If">
                        ...
                        contact@textone.fr <br />
                        Login should be your @intermann.ro adress
                      </p>
                    </div>
                            ...
                            >
                              ...
                              >
                                <img
                                  alt="..."
                                  src={
                                    require("../images/EmailIcon.svg").default
                                  }
                                />
                              </span>
                            ...
                            >
                              ...
                              >
                                <img
                                  alt="..."
                                  src={
                                    require("../images/PasswordInput.svg")
                                      .default
                                  }
                                />
                              </span>
