...
export default function  Header (){
    ...
    <div className="container-fluid">
        <div className="row headerCommercial" >
            <div className="col-8">
                <p className="mb-0">{CurrentPath.includes("/commercialCenter/AddLeads") ? "Ajouter un lead" :"commercial center"  }</p>
                <span className="mb-0">Gestion commercial des leads clients avec Patrick Roggy</span>
            </div>
