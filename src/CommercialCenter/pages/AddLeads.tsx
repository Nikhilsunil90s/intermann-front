...
<textarea name="companyNote"  style={{fontSize:"12px",border :"2px solid #f4f4f4"}}
                         onChange={onInputFormChange}
                         className="form-control nameTransform" placeholder="Note du client">
                         </textarea>
</div>
                     ...
                     <div className="col-12 d-grid mt-1">
                         ...
                         <textarea name="agencyNote"  style={{fontSize:"12px",border :"2px solid #f4f4f4"}}
                         onChange={onInputFormChange}
                         className="form-control nameTransform" placeholder="Note de l’agence " >
