...
export default function Employes() {
  ...
  useEffect(() => {
    ...
    setData({
      ...data,
      candidatName: leadProfile.candidatName,
      candidatEmail: leadProfile.candidatEmail,
      candidatSkills: leadProfile.leadNotes,
      candidatPhone: "+" + leadProfile.candidatPhone.replace(/\D/g, ""),
    });
  }, []);
