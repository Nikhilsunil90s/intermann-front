...
<div className="row px-1 mt-1" style={{width:"102%"}}>
    ...
    borderRadius: "10px"}}>
        ...
        <div className="col-8 d-grid PrECONTACTED">
          <div className="row p-1"> 
          <div className="col-12 " style={{background:`${props.leadContactedByAgency ===  "Not Yet" ? `#d42424` : props.leadContactedByAgency ===  "Not Interested" ? `#d42424` : props.leadContactedByAgency ===  "Yes" ? `#489767` : props.leadContactedByAgency ===  "Recall" ? `#FE8700` :  props.leadContactedByAgency ===  "Phone Closed" ? `#FE8700` : ``}`,
                padding:"10px 15px",
    borderRadius: "10px"}}>             <p className="m-0 ">Contacted by Agency</p>
              ...
              <span>(BY DANA)</span>
                ...
                <div className="col-2 pr-0 d-flex  align-items-center " ><label htmlFor={`1${length}`}  className={`btn d-flex align-items-center  ${Agency === "Not Yet" ?  "offRedBtnAgency": props.leadContactedByAgency ==="Not Yet" ?  "offRedBtnAgency" :  "offBtns"}`}   ><div className="d-flex justify-content-center align-item-center inputBorder"><input type={"radio"} id={`1${length}`}  name={`CAgency${length}`}  onClick={(e)=>OnChangeRadio(e,props._id)} value="Not Yet" className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={props.leadContactedByAgency== "Not Yet" ? true : false} /></div>Not yet</label></div>
