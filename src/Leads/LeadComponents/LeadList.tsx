...
function LeadList({props,Update,Load,Lead,length,activeUser,TabName}){
  ...
  const [Added,setAdded]=useState(props.leadAddedToCRM)as any
...
<div className="row px-1 mt-1" style={{width:"102%"}}>
    ...
    borderRadius: "10px"}}>
              ...
              <div className="row PrECONTACTEDInput mb-1" >
                ...
                <div className="col-4 d-flex  align-items-start"><label   htmlFor={`pre3${length}`} className={`btn d-flex align-items-center ${Precontacted === "Not Interested" ? "offRedBtn" :props.leadPreContacted=== "Not Interested" ? "offRedBtn":"offBtns"}`}><div className="d-flex justify-content-center align-item-center inputBorder"> <input id={`pre3${length}`} type={"radio"}  className="cursor-pointer d-flex" name={`preContact${length}`} value={"Not Interested"} onClick={(e)=>OnChangeRadio(e,props._id)} defaultChecked={Precontacted == "Not Interested" ? true : props.leadPreContacted === "Not Interested" ? true : false } /></div>Not Interested</label></div>
              </div>
            </div>
        ...
        <div className="col-8 d-grid PrECONTACTED">
          <div className="row p-1"> 
          <div className="col-12 " style={{background:`${props.leadContactedByAgency ===  "Not Yet" || props.leadContactedByAgency ===  "No" ? `#d42424` : props.leadContactedByAgency ===  "Not Interested" ? `#d42424` : props.leadContactedByAgency ===  "Yes" ? `#489767` : props.leadContactedByAgency ===  "Recall" ? `#FE8700` :  props.leadContactedByAgency ===  "Phone Closed" ? `#FE8700` : ``}`,
                padding:"10px 15px",
    ...
    borderRight: "1px solid #dcd9d9"
           ...
           <div className="row mx-1">
              ...
              <div className="row PrECONTACTEDInput " >
                <div className="col-6 pr-0  d-flex justify-content-center align-items-center " ><label htmlFor={`Add1${length}`} className={`btn d-flex align-items-center  ${Added === false ? "offRedBtn"  : props.leadAddedToCRM === false ?  "offRedBtn" :  "offBtns"}`}  ><div className="d-flex justify-content-center align-item-center inputBorder"><input id={`Add1${length}`} type={"radio"}  value="false" name={`Added_to_CRM${length}`} onClick={(e)=>OnChangeRadio(e,props._id)} className="cursor-pointer yesNoRadio d-flex"  defaultChecked={Added === false ? true : props.leadAddedToCRM === false ? true : false}/></div>No</label></div>
                <div className="col-6  d-flex justify-content-start align-items-center"><label htmlFor={`Add2${length}`} className={`btn d-flex align-items-center  ${Added === true ? "onGreenBtnContact"  : props.leadAddedToCRM === true ?  "onGreenBtnContact" :  "offBtns"}`} ><div className="d-flex justify-content-center align-item-center inputBorder"> <input id={`Add2${length}`} type={"radio"} value="true" name={`Added_to_CRM${length}`}  onClick={(e)=>OnChangeRadio(e,props._id)}   className="cursor-pointer yesNoRadio d-flex justify-content-center align-items-center" defaultChecked={Added === true ? true : props.leadAddedToCRM === true ? true : false} /></div>Yes</label></div>
                            </div>
            </div>
            </div>
    ...
    borderRight: "1px solid #dcd9d9"
            ...
            <p className="mb-0 ">QUALIFIED</p>
              ...
              <div className="row PrECONTACTEDInput ">
                <div className="col-2 pr-0 d-flex justify-content-start align-items-center " ><label className={`btn d-flex align-items-center  ${Qual === "0" ? "themeColorAgency" : props.leadQualified ===0 ?  "themeColorAgency" :  "offBtns"}`} htmlFor={`Qua0${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua0${length}`} onClick={(e)=>OnChangeRadio(e,props._id)} value={"0"}  type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={Qual  === 0  ? true : props.leadQualified === 0  ? true : false}  /></div>?</label></div>
                <div className="col-2 pr-0 d-flex justify-content-start align-items-center"> <label  className={`btn d-flex align-items-center  ${Qual ==="1" ? "themeColorAgency" :props.leadQualified ===1 ?  "themeColorAgency" :  "offBtns"}`} htmlFor={`Qua1${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua1${length}`} onClick={(e)=>OnChangeRadio(e,props._id)} value={"1"} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={Qual  === 1  ? true : props.leadQualified === 1 ? true : false}  /></div>😟</label></div>
                <div className="col-2 pr-0 d-flex justify-content-start align-items-center"> <label  className={`btn d-flex align-items-center  ${Qual === "2" ? "onGreenBtnContact" :props.leadQualified ===2 ?  "onGreenBtnContact" :  "offBtns"}`} htmlFor={`Qua2${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua2${length}`} onClick={(e)=>OnChangeRadio(e,props._id)} value={"2"} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={Qual  === 2  ? true : props.leadQualified === 2 ? true : false}  /></div>🙁</label></div>
                <div className="col-2 pr-0 d-flex justify-content-start align-items-center"> <label  className={`btn d-flex align-items-center  ${Qual === "3" ? "onGreenBtnContact" :props.leadQualified ===3 ?  "onGreenBtnContact" :  "offBtns"}`} htmlFor={`Qua3${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua3${length}`} onClick={(e)=>OnChangeRadio(e,props._id)} value={"3"} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={Qual  === 3  ? true : props.leadQualified === 3 ? true : false}  /></div>😊</label></div>
                <div className="col-2 pr-0 d-flex justify-content-start align-items-center" style={{marginTop:"5px"}}> <label  className={`btn d-flex align-items-center  ${Qual === "4" ? "onGreenBtnContact" :props.leadQualified ==4 ?  "onGreenBtnContact" :  "offBtns"}`} htmlFor={`Qua4${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua4${length}`} onClick={(e)=>OnChangeRadio(e,props._id)} value={"4"} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={Qual  === 4  ? true : props.leadQualified === 4 ? true : false}  /></div>🥰</label></div>
                <div className="col-2 d-flex justify-content-start align-items-center" style={{marginTop:"5px"}}> <label  className={`btn d-flex align-items-center  ${Qual === "5" ? "onGreenBtnContact" :props.leadQualified ===5 ?  "onGreenBtnContact" :  "offBtns"}`} htmlFor={`Qua5${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua5${length}`} onClick={(e)=>OnChangeRadio(e,props._id)} value={"5"} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={Qual  === 5  ? true : props.leadQualified === 5 ? true : false}  /></div>😍</label></div>
