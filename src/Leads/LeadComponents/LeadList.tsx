...
let NewCdate;
function LeadList({props,Update,Load,Lead,length,activeUser,TabName, setFilter,DAta,setrest}){
...
// AddToCRM(data)
    ...
    borderRadius: "10px"}}>
              ...
              <div className="row PrECONTACTEDInput mb-1" >
                <div className="col-4 pr-0 d-flex align-items-start " ><label   htmlFor={`pre1${length}`} className={`btn d-flex align-items-center ${Precontacted === "Not Yet" || Precontacted === "No"  ? "offRedBtn" :  "offBtns"}`}><div className="d-flex justify-content-center align-item-center inputBorder"><input id={`pre1${length}`} name={`preContact${length}`} value={"Not Yet"} onChange={(e)=>OnChangeRadio(e,props._id)} type={"radio"} className="cursor-pointer d-flex"  checked={Precontacted === "Not Yet" ? true :Precontacted === "No" ? true : false} /></div>Not yet</label></div>
                <div className="col-4 d-flex  align-items-start"><label htmlFor={`pre2${length}`} className={`btn d-flex align-items-center ${Precontacted === "Interested"  ? "onGreenBtn" :"offBtns"}`}> <div className="d-flex justify-content-center align-item-center inputBorder"><input id={`pre2${length}`} type={"radio"} name={`preContact${length}`} value={"Interested"} onChange={(e)=>OnChangeRadio(e,props._id)} className="cursor-pointer d-flex"   checked={ Precontacted === "Interested" ? true : false } /></div>Interested</label></div>
                <div className="col-4 d-flex  align-items-start"><label   htmlFor={`pre3${length}`} className={`btn d-flex align-items-center ${Precontacted === "Not Interested"   ? "offRedBtn" :"offBtns"}`}><div className="d-flex justify-content-center align-item-center inputBorder"> <input id={`pre3${length}`} type={"radio"}  className="cursor-pointer d-flex" name={`preContact${length}`} value={"Not Interested"} onChange={(e)=>OnChangeRadio(e,props._id)} checked={ Precontacted === "Not Interested" ? true : false } /></div>Not Interested</label></div>
              </div>
            </div>
    ...
    borderRadius: "10px"}}>             <p className="m-0 ">Contacted by Agency</p>
              {/* <span>(BY {LoginUser.emailAddress.substring(0,LoginUserS.emailAddress.lastIndexOf("@")).toUpperCase()})</span> */}
                ...
                <div className="col-2 pr-0 d-flex  align-items-center " ><label htmlFor={`1${length}`}  className={`btn d-flex align-items-center  ${Agency === "Not Yet" || Agency === "No"?  "offRedBtnAgency":  "offBtns"}`}   ><div className="d-flex justify-content-center align-item-center inputBorder"><input type={"radio"} id={`1${length}`}  name={`CAgency${length}`}  onChange={(e)=>OnChangeRadio(e,props._id)} value="Not Yet" className="cursor-pointer d-flex justify-content-center align-items-center" checked={props.leadContactedByAgency== "Not Yet" || props.leadContactedByAgency== "No" ? true : false} /></div>Not yet</label></div>
                <div className="col-3  d-flex  align-items-center " ><label htmlFor={`5${length}`}  className={`btn d-flex align-items-center  ${Agency === "Not Interested" ?  "offRedBtnAgency":  "offBtns"}`}   ><div className="d-flex justify-content-center align-item-center inputBorder"><input type={"radio"} id={`5${length}`}  name={`CAgency${length}`}  onChange={(e)=>OnChangeRadio(e,props._id)} value="Not Interested" className="cursor-pointer d-flex justify-content-center align-items-center" checked={props.leadContactedByAgency== "Not Interested" ? true : false} /></div>Not Interested</label></div>
                <div className="col-2  d-flex justify-content-end align-items-center"><label   htmlFor={`2${length}`} className={`btn d-flex align-items-center  ${Agency === "Yes" ?  "onGreenBtnContact" :  "offBtns"}`}  > <div className="d-flex justify-content-center align-item-center inputBorder"><input type={"radio"} id={`2${length}`} name={`CAgency${length}`}  onChange={(e)=>OnChangeRadio(e,props._id)} value="Yes" className="cursor-pointer d-flex justify-content-center align-items-center" checked={props.leadContactedByAgency== "Yes" ? true : false}/></div>Yes</label></div>
                <div className="col-2  d-flex justify-content-end align-items-center"> <label  htmlFor={`3${length}`} className={`btn d-flex align-items-center  ${Agency === "Recall" ?  "themeColorAgency" :  "offBtns"}`} ><div className="d-flex justify-content-center align-item-center inputBorder"><input type={"radio"} id={`3${length}`} name={`CAgency${length}`}  onChange={(e)=>OnChangeRadio(e,props._id)} value="Recall" className="cursor-pointer d-flex justify-content-center align-items-center" checked={props.leadContactedByAgency== "Recall" ? true : false} /></div>Recall</label></div>
                <div className="col-3  d-flex  align-items-center"> <label  htmlFor={`4${length}`}  className={`btn d-flex align-items-center  ${Agency === "Phone Closed" ?  "themeColorAgency" :"offBtns"}`}  ><div className="d-flex justify-content-center align-item-center inputBorder" ><input type={"radio"} id={`4${length}`}  name={`CAgency${length}`}  onChange={(e)=>OnChangeRadio(e,props._id)} value="Phone Closed" className="cursor-pointer d-flex justify-content-center align-items-center" checked={props.leadContactedByAgency== "Phone Closed" ? true : false} /></div>Phone Closed</label></div>
    ...
    borderRight: "1px solid #dcd9d9"
           ...
           <div className="row mx-1">
              ...
              <div className="row PrECONTACTEDInput " >
                <div className="col-6 pr-0  d-flex justify-content-center align-items-center " ><label htmlFor={`Add1${length}`} className={`btn d-flex align-items-center  ${Added === "false" ? "offRedBtn"  :  "offBtns"}`}  ><div className="d-flex justify-content-center align-item-center inputBorder"><input id={`Add1${length}`} type={"radio"}  value={"false"} name={`Added_to_CRM${length}`} onChange={(e)=>OnChangeRadio(e,props._id)} className="cursor-pointer yesNoRadio d-flex"  checked={Added === false ? true : props.leadAddedToCRM === false ? true : false}/></div>No</label></div>
                <div className="col-6  d-flex justify-content-start align-items-center"><label htmlFor={`Add2${length}`} className={`btn d-flex align-items-center  ${Added === "true" ? "onGreenBtnContact"  :  "offBtns"}`} ><div className="d-flex justify-content-center align-item-center inputBorder"> <input id={`Add2${length}`} type={"radio"} value={"true"} name={`Added_to_CRM${length}`}  onChange={(e)=>OnChangeRadio(e,props._id)}   className="cursor-pointer yesNoRadio d-flex justify-content-center align-items-center" checked={Added === true ? true : props.leadAddedToCRM === true ? true : false} /></div>Yes</label></div>
                            </div>
            </div>
            </div>
    ...
    borderRight: "1px solid #dcd9d9"
            ...
            <p className="mb-0 ">QUALIFIED</p>
              ...
              <div className="row PrECONTACTEDInput ">
                <div className="col-2 pr-0 d-flex justify-content-start align-items-center " ><label className={`btn d-flex align-items-center  ${Qual == 0 ? "offRedBtnAgency" :   "offBtns"}`} htmlFor={`Qua0${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua0${length}`} onChange={(e)=>OnChangeRadio(e,props._id)} value={0}  type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" checked={Qual  === 0  ? true : props.leadQualified === 0  ? true : false}  /></div>?</label></div>
                <div className="col-2 pr-0 d-flex justify-content-start align-items-center"> <label  className={`btn d-flex align-items-center  ${Qual == 1 ? "themeColorAgency" :  "offBtns"}`} htmlFor={`Qua1${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua1${length}`} onChange={(e)=>OnChangeRadio(e,props._id)} value={1} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" checked={Qual  === 1  ? true : props.leadQualified === 1 ? true : false}  /></div>😟</label></div>
                <div className="col-2 pr-0 d-flex justify-content-start align-items-center"> <label  className={`btn d-flex align-items-center  ${Qual == 2 ? "onGreenBtnContact" :  "offBtns"}`} htmlFor={`Qua2${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua2${length}`} onChange={(e)=>OnChangeRadio(e,props._id)} value={2} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" checked={Qual  === 2  ? true : props.leadQualified === 2 ? true : false}  /></div>🙁</label></div>
                <div className="col-2 pr-0 d-flex justify-content-start align-items-center"> <label  className={`btn d-flex align-items-center  ${Qual == 3 ? "onGreenBtnContact" :  "offBtns"}`} htmlFor={`Qua3${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua3${length}`} onChange={(e)=>OnChangeRadio(e,props._id)} value={3} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" checked={Qual  === 3  ? true : props.leadQualified === 3 ? true : false}  /></div>😊</label></div>
                <div className="col-2 pr-0 d-flex justify-content-start align-items-center" style={{marginTop:"5px"}}> <label  className={`btn d-flex align-items-center  ${Qual == 4 ? "onGreenBtnContact" :  "offBtns"}`} htmlFor={`Qua4${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua4${length}`} onChange={(e)=>OnChangeRadio(e,props._id)} value={4} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" checked={Qual  === 4  ? true : props.leadQualified === 4 ? true : false}  /></div>🥰</label></div>
                <div className="col-2 d-flex justify-content-start align-items-center" style={{marginTop:"5px"}}> <label  className={`btn d-flex align-items-center  ${Qual == 5 ? "onGreenBtnContact" :"offBtns"}`} htmlFor={`Qua5${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua5${length}`} onChange={(e)=>OnChangeRadio(e,props._id)} value={5} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" checked={Qual  === 5  ? true : props.leadQualified === 5 ? true : false}  /></div>😍</label></div>
    ...
    {NoteEditModal ?
            <NotesEditModal closeModal={setNoteEditsModal} props={props} update={Update} Load={Load} deleteModal={setNotesDeleteModal} setrest={setrest} Notes={LeadNotes} setDelete={setDeleteLeads} setFilter={setFilter} DAta={DAta}  />
:
null
    ...
    }
      {
            ...
            null
              ...
              {NoteDeleteModal ?
                   <ConfirmDelete closeModal={setNotesDeleteModal} setrest={setrest}  props={props}  update={Update}  Load={Load}  Notes={LeadNotes} LeadsDelete={DeleteLeads} setDelete={setDeleteLeads} setFilter={setFilter} />
