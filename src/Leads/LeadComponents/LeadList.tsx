...
AddToCRM(data)
    ...
    borderRadius: "10px"}}>             <p className="m-0 ">Contacted by Agency</p>
              <span>(BY {LoginUser.emailAddress.substring(0,LoginUserS.emailAddress.lastIndexOf("@")).toUpperCase()})</span>
                ...
                <div className="col-3  d-flex justify-content-end align-items-center"> <label  htmlFor={`3${length}`} className={`btn d-flex align-items-center  ${Agency === "Recall" ?  "themeColorAgency" : props.leadContactedByAgency ==="Recall" ?  "themeColorAgency" :  "offBtns"}`} ><div className="d-flex justify-content-center align-item-center inputBorder"><input type={"radio"} id={`3${length}`} name={`CAgency${length}`}  onClick={(e)=>OnChangeRadio(e,props._id)} value="Recall" className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={props.leadContactedByAgency== "Recall" ? true : false} /></div>Recall</label></div>
                <div className="col-4  d-flex  align-items-center"> <label  htmlFor={`4${length}`}  className={`btn d-flex align-items-center  ${Agency === "Phone Closed" ?  "themeColorAgency" :props.leadContactedByAgency ==="Phone Closed" ?  "themeColorAgency" :  "offBtns"}`}  ><div className="d-flex justify-content-center align-item-center inputBorder" ><input type={"radio"} id={`4${length}`}  name={`CAgency${length}`}  onClick={(e)=>OnChangeRadio(e,props._id)} value="Phone Closed" className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={props.leadContactedByAgency== "Phone Closed" ? true : false} /></div>Phone Closed</label></div>
              </div>
              </div>
    ...
    borderRight: "1px solid #dcd9d9"
            ...
            <p className="mb-0 ">QUALIFIED</p>
              ...
              <div className="row PrECONTACTEDInput ">
                ...
                <div className="col-2 d-flex justify-content-start align-items-center"> <label  className={`btn d-flex align-items-center  ${Qual ==="1" ? "themeColorAgency" :props.leadQualified ===1 ?  "themeColorAgency" :  "offBtns"}`} htmlFor={`Qua1${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua1${length}`} onClick={(e)=>OnChangeRadio(e,props._id)} value={"1"} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={Qual  === 1  ? true : props.leadQualified === 1 ? true : false}  /></div>😟</label></div>
                <div className="col-2 d-flex justify-content-start align-items-center"> <label  className={`btn d-flex align-items-center  ${Qual === "2" ? "onGreenBtnContact" :props.leadQualified ===2 ?  "onGreenBtnContact" :  "offBtns"}`} htmlFor={`Qua2${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua2${length}`} onClick={(e)=>OnChangeRadio(e,props._id)} value={"2"} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={Qual  === 2  ? true : props.leadQualified === 2 ? true : false}  /></div>🙁</label></div>
                <div className="col-2 d-flex justify-content-start align-items-center"> <label  className={`btn d-flex align-items-center  ${Qual === "3" ? "onGreenBtnContact" :props.leadQualified ===3 ?  "onGreenBtnContact" :  "offBtns"}`} htmlFor={`Qua3${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua3${length}`} onClick={(e)=>OnChangeRadio(e,props._id)} value={"3"} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={Qual  === 3  ? true : props.leadQualified === 3 ? true : false}  /></div>😊</label></div>
                <div className="col-2 d-flex justify-content-start align-items-center" style={{marginTop:"5px"}}> <label  className={`btn d-flex align-items-center  ${Qual === "4" ? "onGreenBtnContact" :props.leadQualified ==4 ?  "onGreenBtnContact" :  "offBtns"}`} htmlFor={`Qua4${length}`}> <div className="d-flex justify-content-center align-item-center inputBorder"> <input  name={`QUALIFIED${length}`} id={`Qua4${length}`} onClick={(e)=>OnChangeRadio(e,props._id)} value={"4"} type={"radio"} className="cursor-pointer d-flex justify-content-center align-items-center" defaultChecked={Qual  === 4  ? true : props.leadQualified === 4 ? true : false}  /></div>🥰</label></div>
