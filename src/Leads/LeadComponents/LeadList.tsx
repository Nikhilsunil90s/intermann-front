...
AddToCRM(data)
    ...
    borderRadius: "10px"}}>
              ...
              <div className="row PrECONTACTEDInput mb-1" >
                ...
                <div className="col-5 d-flex  align-items-start"><label   htmlFor={`pre3${length}`} className={`btn d-flex align-items-center ${Precontacted === "Not Interested" ? "offRedBtn" :props.leadPreContacted=== "Not Interested" ? "offRedBtn":"offBtns"}`}><div className="d-flex justify-content-center align-item-center inputBorder"> <input id={`pre3${length}`} type={"radio"}  className="cursor-pointer d-flex" name={`preContact${length}`} value={"Not Interested"} onClick={(e)=>OnChangeRadio(e,props._id)} defaultChecked={Precontacted == "Not Interested" ? true : props.leadPreContacted === "Not Interested" ? true : false } /></div>Not Interested</label></div>
              </div>
            </div>
