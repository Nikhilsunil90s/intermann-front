...
<div className="row px-1 mt-1" style={{width:"115%"}}>
    ...
    borderRadius: "10px"}}>
              ...
              <div className="row PrECONTACTEDInput mb-1" >
                <div className="col-4 pr-0 d-flex align-items-start " ><label   htmlFor={`pre1${length}`} className={`btn d-flex align-items-center ${Precontacted === "No" ? "offRedBtn" : props.leadPreContacted ==="No" ?  "offRedBtn" :  "offBtns"}`}><div className="d-flex justify-content-center align-item-center inputBorder"><input id={`pre1${length}`} name={`preContact${length}`} value={"No"} onClick={(e)=>OnChangeRadio(e,props._id)} type={"radio"} className="cursor-pointer d-flex"  defaultChecked={Precontacted == "No" ? true : props.leadPreContacted === "No" ? true : false } /></div>Not yet</label></div>
