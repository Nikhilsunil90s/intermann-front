...
function CSVModal({props,closeModal,}){
  ...
  <div className="modal d-block" style={{ backgroundColor: "#00000052" }} id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div className="modal-dialog modal-lg" style={{width:"605px",marginTop:"100px"}}>
                <div className="modal-content">
                    ...
                    <div className="modal-body text-start">
                        <div className="col-12 d-flex justify-content-center align-items-center" style={{height:"19vh"}}>
     <p className="mb-0 d-grid"  style={{
                            fontFamily: 'Poppins',
                            fontStyle: "normal",
                            fontWeight: "600",
                            fontSize: "18px",
