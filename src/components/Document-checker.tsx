...
function DocumentCheck() {
  ...
  useEffect(() => {
    ...
    if (todoClient.length === 0) {
      let TClient = data.filter((el) => el.jobStatus == "To-Do");
      settodoClient([...TClient]);
    }
    if (Inprogress.length === 0) {
      let TClient = data.filter((el) => el.jobStatus == "In-Progress");
      setInprogress([...TClient]);
    }
    if (Archived.length === 0) {
      let TClient = data.filter((el) => el.jobStatus == "Archived");
      setArchived([...TClient]);
    }
    if (ClientSigned.length === 0) {
      let TClient = data.filter((el) => el.jobStatus == "Signed Contract");
    ...
    if (e.target.name === "To-Do") {
      let TClient = todoClient.filter((el) =>
        el.clientCompanyName
          ...
          .toLowerCase()
          .replaceAll(" ", "")
          .includes(e.target.value.toString().toLowerCase().replaceAll(" ", ""))
      );
      ...
      <div className="container-fluied bg-ContractPage">
        <div className="row searchBarChecker">
          ...
          <div className="col-12 text-center" style={{ padding: "0px 20px" }}>
            ...
            <p className="pouvez mb-0">
              Les clients de la société sont listés sur cette page, vous pouvez
              cliquer sur un client et faire un controle des documents
              obligatoires.
            </p>
            <p className="pouvezz">
              Chaque client doit avoir accès à sa propre page qui doit lui etre
              communiqué par Jeremy
            </p>
          </div>
          ...
          <div className="col-12 ">
            <div
              id="navbar-example2"
              className="row align-items-center bg-light py-1"
            >
              <div className="col-3 px-0">
                <a
                  className={
                    activeTab == "scrollspyHeading1"
                      ? "sommeilTabActive"
                      : "sommeilTab"
                  }
                  onClick={() => onColorChange("scrollspyHeading1")}
              ...
              <div className="col-3 px-0">
                <a
                  className={
                    activeTab == "scrollspyHeading2"
                      ? "sommeilTabActive"
                      : "sommeilTab"
                  }
                  onClick={() => onColorChange("scrollspyHeading2")}
                  href="#scrollspyHeading2"
                >
                  🔍 Clients en cours de recherche
                </a>
              </div>
              <div className="col-3 px-0">
                <a
                  className={
                    activeTab == "scrollspyHeading3"
                      ? "sommeilTabActive"
                      : "sommeilTab"
                  }
                  onClick={() => onColorChange("scrollspyHeading3")}
              ...
              <div className="col-3 px-0">
                <a
                  className={
                    activeTab == "scrollspyHeading4"
                      ? "sommeilTabActive"
                      : "sommeilTab"
                  }
                  onClick={() => onColorChange("scrollspyHeading4")}
                  href="#scrollspyHeading4"
                >
                  🗑️ Clients EN archives ?
                </a>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              <div className="row">
                  ...
                  <div className="wrapBar">
                    <div className="searchBarClient">
                      <input
                        ...
                        placeholder="😴 Clients en sommeil ?"
                      />
                ...
                <span className="travaillant pl-4">
                  Les clients ne travaillant pas encore avec nous, vous pouvez
                  quand meme voir l’offre envoyé.{" "}
                </span>
              </div>
            </div>
            <div
              className="col-12 scrollbarBox my-2"
              style={{ padding: "0px 50px", overflow: "auto" }}
            >
              <div className="row scrollbarBox  justify-content-between">
                {todoClient.length > 0 ? (
                  FilterTodoFalse ? (
                    FilterData.map((el) => (
                      <div
                        className="col-lg-4 col-sm-6 d-flex align-items-center justify-content-center boxClientName cursor-pointer mb-1 p-1"
                        style={{ maxWidth: "32%", height: "130px" }}
                        onClick={(e) =>
                          DocumentClientPage(el._id, el.clientCompanyName)
                        }
                      >
                        <p className="ClientNameBox mb-0">
                          📂
                          {el.clientCompanyName.length > 13
                            ? el.clientCompanyName
                                .slice(0, 13)
                                .toLocaleUpperCase() + "..."
                            : el.clientCompanyName.toLocaleUpperCase()}
                        </p>
                      </div>
                    ))
                  ) : (
            ...
            >
              <div className="row">
                  ...
                  <div className="wrapBar" style={{ width: "55%" }}>
                    <div className="searchBarClient">
                      <input
                        ...
                        name="inProgress"
                        onChange={FilterByName}
                        placeholder="🔍 Clients en cours de recherche ?"
                      />
                      <button type="submit" className="searchButton">
                        <i className="fa fa-search"></i>
                      </button>
                ...
                <span className="travaillant pl-4">
                  Les clients ayant signés l’offre sans pour autant avoir des
                  employés.{" "}
                </span>
              </div>
            </div>
            ...
            >
              <div className="row">
                ...
                <span className="travaillant pl-4">
                  Les clients ayant signés le contrat et ayant des employés
            ...
            >
              <div className="row">
                  ...
                  <div className="wrapBar">
                    <div className="searchBarClient">
                      <input
                        ...
                        name="Archive"
                        onChange={FilterByName}
                        placeholder="🗑️ Clients EN archives ?"
                      />
                      <button type="submit" className="searchButton">
                        <i className="fa fa-search"></i>
                      </button>
                ...
                <span className="travaillant pl-4">
                  Les clients qui ont été supprimés pour une raison quelconque{" "}
                </span>
              </div>
            </div>
            <div
        ...
        <div className="row MobileView mb-1" style={{ height: "100vh" }}>
          <div className="col-12 p-1" style={{ height: "10vh" }}>
            <div className="row px-1 mt-1">
              <div className="col-4" onClick={(e) => CloseMenu()}>
                <img alt="..."
                   src={
                    require(onClickMenuOpen
                      ? "../images/menuClose.svg"
                      : "../images/menu.svg").default
                  }
                />
              </div>
          ...
          {onClickMenuOpen ? (
            <div
              className="col-12 "
              style={{ background: "#032339", height: "90vh" }}
            >
              <div className="row px-2" style={{ height: "90%" }}>
                <div
                  className="col-12"
                  style={{ background: "#ffff", borderRadius: "15px" }}
                >
                  <ul className="pt-1" style={{ listStyle: "none" }}>
                    <li
                      className={
                        activeTab == "todo" ? "somilActiveTab" : "somil"
                      }
                      onClick={() => onColorChange("todo")}
                    >
                      😴 Clients en sommeil
                    </li>
                    <li
                      className={
                        activeTab == "inprogress" ? "somilActiveTab" : "somil"
                      }
                      onClick={() => onColorChange("inprogress")}
                    >
                      🔍 Clients en cours de recherche
                    </li>
                    <li
                      className={
                        activeTab == "contract" ? "somilActiveTab" : "somil"
                      }
                      onClick={() => onColorChange("contract")}
                    >
                      ✅ Clients EN COURS
                    </li>
                    <li
                      className={
                        activeTab == "archive" ? "somilActiveTab" : "somil"
                      }
                      onClick={() => onColorChange("archive")}
                    >
                      🗑️ Clients EN archives{" "}
                    </li>
                  </ul>
            ...
            <>
              ...
              >
                <p className="verification mb-0">Vérification de documents</p>
                <p className="pouvez mb-1 ">
                  Les clients de la société sont listés sur cette page, vous
                  pouvez cliquer sur un client et faire un controle des
                  documents obligatoires.
                </p>
                <b className="pouvezz ">
                  Chaque client doit avoir accès à sa propre page qui doit lui
                  etre communiqué par Jeremy
                </b>
              </div>
              <div className="LineHR" />
              <div className="col-12 text-center">
                <p className="travaillant">
                  Les clients ne travaillant pas encore avec nous, vous pouvez
                  quand meme voir l’offre envoyé.{" "}
                </p>
              </div>
                ...
                <div className="row justify-content-around">
                  {TodoMobile ? (
                    todoClient.length > 0 ? (
                      todoClient.map((el) => (
                        <div
                          className="col-6  d-flex align-items-center justify-content-center boxClientName cursor-pointer mb-1 p-1"
                          style={{ maxWidth: "45%", height: "100px" }}
                          onClick={(e) =>
                            DocumentClientPage(el._id, el.clientCompanyName)
                          }
                        >
