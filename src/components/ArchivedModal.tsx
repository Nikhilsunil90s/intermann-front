    ...
    <div className="modal d-block" style={{ backgroundColor: "#00000052" }} id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div className="modal-dialog modal-lg">
        <div className="modal-content padding-full">
          ...
          <h2 className="modal-title pRight" id="staticBackdropLabel">Move {props.candidatName} to <span className="text-danger">Archived</span> </h2>
          <div className="modal-body text-start">
            <p style={{
              ...
              lineHeight: "24px",
              color: "#373A3C"
            }}>What is the reason of this archived ? Pourquoi {props.candidatName} is archived ? </p>
            <form onSubmit={() => { sendArchiveRequest(); return false; }}>
              ...
              <div className="col-12 text-center pt-3">
                <div className="row ">
                  ...
                  <div className="col-6">
                    ...
                    >Move {props.candidatName} to Status Archived.</button>
                  </div>
