...
const ArchivedProfileCard = (props: any) => {
  ...
  const [candidatMotivationIcons] = useState([
  ...
  return (
    <>
      <div className="card card-color mt-1 mb-0 HoveRESTClassCardA">
        <div
          className="card-upper cursor-pointer"
          onClick={() => viewFullProfile()}
        >
          <div className="col-4 d-flex align-items-center justify-content-center">
            {props.props.candidatPhoto &&
            props.props.candidatPhoto?.url !== undefined ? (
              <img
          ...
          <div className="col-7 ArchivedCard pt-1 px-1">
            <p
              ...
              title={props.props.candidatName.toLocaleUpperCase()}
            >
              {props.props.candidatName.length > 15
                ? props.props.candidatName.slice(0, 16).toLocaleUpperCase() +
                  "..."
                : props.props.candidatName.toLocaleUpperCase()}
            </p>
            <div className="text-dark mb-0">
              {props.props.candidatAge ? (
                <p className="age00 ml-0 mb-0">
                  Age : {props.props.candidatAge}
                </p>
              ) : (
                <b>Age : ✘!</b>
              )}
            ...
            <div>
              {" "}
              <p className="text-dark d-flex" style={{ fontWeight: "600" }}>
                {props.props.candidatMotivation
                  ? props.props.candidatMotivation == 0
                    ? candidatMotivationIcons[props.props.candidatMotivation]
                        .icon +
                      " " +
                      candidatMotivationIcons[props.props.candidatMotivation]
                        .motivation
        ...
        <div className="col-12 ">
          <div className="row cardColorRowArchived" style={{ height: "49px" }}>
            <div className="col-6 d-flex align-items-center">
              <Link to="#">
                <button className="ArchivedCardBtn p-0">
                  <img
                    className="m-0"
        ...
        <div className="card-todoBody pl-0">
          <div className="px-0  mb-1 " style={{ marginLeft: "6px" }}>
            ...
            <p className="ArchivedCardChildFonts mb-0">
              Secteur:{" "}
              <b>
                {" "}
                {props.props.candidatActivitySector
                  ? props.props.candidatActivitySector.toLocaleUpperCase()
                  : "✘ No Sector!"}
              </b>
            </p>
            <p className="ArchivedCardChildFonts mb-0">
              ...
              <b>
                {" "}
                {props.props.candidatJob
                  ? props.props.candidatJob.toLocaleUpperCase()
                  : "✘ No Job!"}
              </b>
            </p>
            <p className="ArchivedCardChildFonts mb-0">
              ...
              <b>
                {props.props.candidatAge
                  ? props.props.candidatAge + "years old"
                  : "✘ Age Not Available!"}
              </b>
            </p>
            <p className="ArchivedCardChildFonts mb-0">
              ...
              <b>
                {" "}
                {props.props.candidatLanguages.length
                  ? props.props.candidatLanguages.length > 3
                    ? props.props.candidatLanguages.slice(0, 3).join(", ") +
                      "..."
                    : props.props.candidatLanguages.join(", ")
                  : "✘ No Langues Selected!"}{" "}
              </b>
            </p>
            <p className="ArchivedCardChildFonts mb-0">
            ...
            <p className="ArchivedCardChildFonts mb-0">
              Facebook URL:{" "}
              <b>
                {props.props.candidatFBURL ? (
                  <a
                    href={props.props.candidatFBURL}
                    target="_blank"
                    className="fbURL"
                  >
            ...
            <p className="ArchivedCardChildFonts mb-0">
              Email:{" "}
              <b>
                {props.props.candidatEmail
                  ? props.props.candidatEmail.length > 20
                    ? props.props.candidatEmail
                        .slice(0, 22)
                        .toLocaleUpperCase() + "..."
                    : props.props.candidatEmail.toLocaleUpperCase()
                  : "✘ No Email Provided!"}
              </b>{" "}
            </p>
            <p
          ...
          <div className="box-red pl-1">
            <p>
              {" "}
              <b>REASON WHY CANCELED</b> :{" "}
            </p>
            <span>
              {" "}
              {props.props.candidatArchived?.reason
                ? props.props.candidatArchived?.reason
                : "✘ No Reason Specified!"}
            </span>
          </div>
