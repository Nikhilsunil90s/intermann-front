...
function SignedClientModal({ props, closeModal }) {
  ...
  const notifyMoveSuccess = () =>
    toast.success("Moved Client to Signed Contract Status Successfully!");
            ...
            <form onSubmit={saveFormData}>
              <div className="modal-body text-start mt-1">
                <div className="text-center">
                  Move {props.clientCompanyName.toUpperCase()} to Signed
                  Contract Status ?
                </div>
                  ...
                  <div className="row ">
                    ...
                    <div className="col-9">
                      ...
                      >
                        <p className="mb-0">
                          I Confirm. <br />
                          Move this lead/client to Signed Contract status.
                        </p>
                      </button>
                    </div>
