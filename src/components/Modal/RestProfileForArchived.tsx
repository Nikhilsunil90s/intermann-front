...
function RestProfile({ props, closeModal, path }) {
        ...
        <div className="modal d-block" style={{ backgroundColor: "#00000052" }} id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div className="modal-dialog modal-lg">
                <div className="modal-content">
                    ...
                    <h2 className="modal-title  py-1 pRight" id="staticBackdropLabel">REST This {props.clientCompanyName} <span className="" style={{color:"#489767",marginLeft:"5px"}}> Profile.</span> </h2>
                    </div>
