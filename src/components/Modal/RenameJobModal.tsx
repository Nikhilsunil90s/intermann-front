...
function RenameJobModal({ sector, closeModal, jobName }) {
  ...
  const notifyJobRenameSuccess = () =>
    toast.success("Job Renamed Successfully!");
  const notifyJobRenameError = () =>
    toast.error("Cannot Be Renamed! Please Try Again.");
          ...
          <div className="modal-content">
              ...
              <div className="col-12">
                <div className="row">
                  <div className="col-10 text-start">
                    ...
                    >
                      Rename Job - {jobName.toUpperCase()}
                    </h5>
                  </div>
            ...
            <div className="modal-body text-center">
              <input
                ...
                required
                placeholder={"Enter New Name for Job - " + jobName}
              />
            </div>
            <div className="modal-footer">
              ...
              <button
                ...
                className="btn"
                style={{
                  backgroundColor: "#3F76E2",
                  borderRadius: "22px",
                  border: "0px",
                  color: "#fff",
                }}
                disabled={btnDisabled}
                onClick={saveNewJobName}
              >
                Save Changes To Job Name
              </button>
            </div>
          </div>
        </div>
