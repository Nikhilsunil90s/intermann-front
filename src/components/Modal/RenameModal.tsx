...
function RenameModal({ props, closeModal }) {
  ...
  const notifySectorRenameSuccess = () =>
    toast(
      "Sector Renamed Successfully! You can Add More Jobs to this Sector",
      {}
    );
  const notifySectorRenameError = () =>
    toast("Cannot Be Renamed! Please Try Again.", {});

  const notifyGeneralError = () =>
    toast("Sector Rename Failed! Please Try Again.", {});
          ...
          <div className="modal-content">
            ...
            <div className="modal-body text-center">
              <input
                ...
                placeholder={"Enter New Name for Sector - " + props}
              />
            </div>
                ...
                <div className="row justify-content-end">
                  ...
                  <div className="col-9">
                    <button
                      ...
                      onClick={saveNewSectorName}
                    >
                      Save Changes To Sector Name
                    </button>
                  </div>
                </div>
              </div>
