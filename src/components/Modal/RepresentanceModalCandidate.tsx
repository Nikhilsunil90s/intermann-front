...
function Representance ({props,closeModal,rePid,LinkModal,setReAvance}){
  ...
  const RepresentFormat={
    ...
    candidat_birthday:DataP ? DataP.candidat_birthday ? DataP.candidat_birthday :"":"",
    candidat_birthcity:DataP ? DataP.candidat_birthcity ? DataP.candidat_birthcity :"":"",
    debut_mission_date:DataP ? DataP.debut_mission_date ? DataP.debut_mission_date :"":"",
    fin_mission_date:DataP ? DataP.fin_mission_date ? DataP.fin_mission_date : "" :"",
    company_address:DataP ? DataP.company_address ? DataP.company_address : "":"",
...
<div className="row justify-content-center">
    <LoaderLoad     />
      ...
      <div className="row">
      <div className="col-4">
              <label className="ChildStylePreModal">candidat_name</label>
              <input className="form-control" defaultValue={props.candidatName.toLocaleUpperCase()}  style={{fontSize:"12px",fontFamily:"Poppins"}} placeholder="candidate_birthday_date" name="candidatName" disabled />
          </div>
          <div className="col-4">
              <label className="ChildStylePreModal">candidate_birthday_date</label>
              <input className="form-control" type={"date"} onChange={onFormChange} defaultValue={DataP ? DataP.candidat_birthday ? candiateBirth :"" :""}  name="candidat_birthday" style={{fontSize:"12px",fontFamily:"Poppins"}} placeholder="candidate_birthday_date"  />
          </div>
          <div className="col-4">
          <label className="ChildStylePreModal">candidate_birth_city</label>
              <input className="form-control"  onChange={onFormChange} defaultValue={DataP ? DataP.candidat_birthcity ? DataP.candidat_birthcity :"" :""} style={{fontSize:"12px",fontFamily:"Poppins"}} placeholder="candidat_birthcity" name="candidat_birthcity" />
          </div>
          <div className="col-4 mt-1">
          <label className="ChildStylePreModal"  >debut_mission</label>
              <input className="form-control" type={"date"}  onChange={onFormChange} style={{fontSize:"12px",fontFamily:"Poppins"}}  defaultValue={DataP ? DataP.debut_mission_date ?debutMiss :"" :""} placeholder="debut_mission_date" name="debut_mission_date" />
          </div>
          <div className="col-4 mt-1">
          <label className="ChildStylePreModal">fin_mission</label>
              <input className="form-control" type={"date"}  onChange={onFormChange} style={{fontSize:"12px",fontFamily:"Poppins"}}  defaultValue={DataP ? DataP.fin_mission_date ? DateFin :"" :""} placeholder="fin_mission_date" name="fin_mission_date" />
          </div>
          <div className="col-4 mt-1">
          <label className="ChildStylePreModal">company_name</label>
              <input className="form-control"  onChange={onFormChange} style={{fontSize:"12px",fontFamily:"Poppins"}}  defaultValue={DataP ? DataP.company_name ? DataP.company_name :"" :""} placeholder="company_adress" name="company_name" />
          </div>
          <div className="col-4 mt-1">
          <label className="ChildStylePreModal">company_adress</label>
              <input className="form-control"  onChange={onFormChange} defaultValue={DataP ? DataP.company_address ? DataP.company_address :"" :""} style={{fontSize:"12px",fontFamily:"Poppins"}} placeholder="company_adress" name="company_address" />
          </div>
      </div>
  }
            ...
            <div className="modal-footer">
                <div className="col-12">
                    <div className="row justify-content-end">
                        <div className="col-3 ">
                        <button type="button" onClick={(e)=>FormSubmit(e)} name="Generate" className="btn preSelectedStageBtn"  style={{width:"100%",background:"#3F76E2"}} >
                        Generate the PDF
              </button>
                        </div>
                        <div className="col-4">
                        <button type="button" onClick={(e)=>FormSubmit(e)} name="DOCUSIGN" className="btn preSelectedStageBtn"  style={{width:"100%",background:"#032339"}}>
                        DOCUSIGN DOC
              </button>
                        </div>
                    </div>
