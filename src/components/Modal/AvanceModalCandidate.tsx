...
function AvanceModal({ props, closeModal, LinkModal, rePid, setReAvance }) {
  ...
  useEffect(() => {
    GetFields().then((resD) => {
      if (resD.status) {
        ...
        setData({
          ...data,
          period_avance: resD.data.period_avance,
          amount_avance: resD.data.amount_avance,
          candidat: props._id,
          candidatName: props.candidatName,
          avanceId: resD.data._id,
        });
        rePid(resD.data._id);
  ...
  const GetFields = async () => {
    ...
    return await fetch(
      API_BASE_URL + `getCandidatAvance/?candidatId=${props._id}`,
      {
        method: "GET",
        headers: headers,
      }
                    ...
                    <>
                      <div className="col-4">
                        ...
                        <input
                          ...
                          defaultValue={props.candidatName}
                      ...
                      <div className="col-4">
                        ...
                        <input
                          className="form-control"
                          defaultValue={
                            data.amount_avance !== "" ? data.amount_avance : ""
                          }
                          onChange={OnFormChange}
                          style={{ fontSize: "12px", fontFamily: "Poppins" }}
                          placeholder="amount_avance"
                          name="amount_avance"
                        />
                        <span
                          style={{
                        ...
                        >
                          The amount that the worker request (Exemple: 1000lei)
                        </span>
                      </div>
                      <div className="col-4">
                        <label className="ChildStylePreModal">
                        ...
                        <input
                          className="form-control"
                          defaultValue={
                            data.period_avance !== "" ? data.period_avance : ""
                          }
                          style={{ fontSize: "12px", fontFamily: "Poppins" }}
                          placeholder="period _avance"
                          name="period _avance"
                          onChange={OnFormChange}
                        />
                        <span
                        ...
                        >
                          When this anvance will be deducted from salary
                          (Exemple octombrie 2022){" "}
                        </span>
                      </div>
                    </>
                  )}
