    ...
    return (<>
        ...
        <div className="modal d-block" style={{ backgroundColor: "#00000052" }} id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel">
            <div className="modal-dialog modal-lg">
                ...
                <h2 className="modal-title " id="staticBackdropLabel">Move {props.clientCompanyName} to<span className="col-spl ">IN-PROGRESS</span> </h2>
                   </div>
                    ...
                    <form onSubmit={saveFormData}>
                        <div className="modal-body text-center">
                            <div className="Modal-bodyText ">
                             <p className="">  This status means that we strated active reseach on this client and we will spend
                                money on this research.</p>
                                <p>Cette société a signé l’offre et nous commençons à dépenser de l’argent pour trouver des candidats</p>
                            </div>
                            <div className="col-12 text-center pt-3">
                                <div className="row text-center">
                                        ...
                                        className="btnClient-Modal"
                                            type="submit"
                                        >
                                            <p className="mb-0">I Confirm. Move this lead/client to in Progress status.</p>
                                        </button>
                                        </div>
                                </div>
                            </div>
