...
function CandidateContract({ props, path }) {
  ...
  return (
    <>
      ...
      <div className="col-4  d-grid text-start">
        <label className="PDFFormlabel  d-flex align-items-start ">
          Durée_Hebdomadaire_Mission
        </label>
        <input
          className="form-control inputStylingForView"
          onClick={editCandidatProfile}
      ...
      <div className="col-12  d-grid text-start">
        ...
        <textarea
          className="TextAreaPage form-control"
          onClick={editCandidatProfile}
          readOnly
          value={
            props.candidatContract
