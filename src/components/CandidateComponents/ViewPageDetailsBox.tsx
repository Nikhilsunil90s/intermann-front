    ...
    return(<>
       <div className="Todo-CardMore force-overflow">
                  <div className="row ">
                      ...
                      <p>Langues  </p>
                      <span className="Todo-CardMore-span">:  {props.candidatLanguages.length  ? props.candidatLanguages.join(", ") : "✘✘No Language!"}</span>
                      </div>
                    </div>
                    <div className="d-flex align-items-center">
                    ...
                    <div className="d-flex align-items-center">
                    <div className="d-flex"> <p>Skills/note </p> <span className="Todo-CardMore-span text-capitalize">: {props.candidatSkills ? props.candidatSkills : "✘✘No Skills!"}</span></div>
