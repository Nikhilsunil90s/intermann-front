...
function SocialButtons({props}){
    ...
    return(<>
     <div className="text-start px-1">
                  ...
                  {
                    props.candidatEmail ?       <button className=" btn-gmail my-1">
                    <a
                ...
                <div className="text-start px-1">
                  <p className="Span-Styling my-2 px-3"> {props.candidatFBURL ? "Facebook :" + props.candidatFBURL : null}</p>
                  </div>
                  {
props.candidatFBURL ?
<a
...
null
            ...
            <div className="text-start px-1">
                  ...
                  props.candidatPhone ?
                      ...
                      <a
                      href={`https://wa.me/${props.candidatPhone}`}
                      target="_blank"
                    >
               ...
               <div className="text-start px-1">
                  ...
                  {props.candidatAlternatePhone ?" Phone 2 :" + props.candidatAlternatePhone : null}
                  </p>
                  </div>
                 {
