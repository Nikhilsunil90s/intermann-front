    ...
    <>
      <div className="card card-color mb-0 HoveRESTClassCardIn">
            ...
            <>
              ...
              <div className="col-7 EmbauchCard pt-1 px-0">
                <p
                  ...
                  title={profile.candidatName.toLocaleUpperCase()}
                >
                  <b>
                    {profile.candidatName.length > 20
                      ? profile.candidatName.slice(0, 21).toLocaleUpperCase() +
                        "..."
                      : profile.candidatName.toLocaleUpperCase()}
                  </b>
                </p>
                <div className="text-dark EmbauchCard mb-0">
                  {profile.candidatAge !== "" ? (
                    <p className="age00 ml-0 mb-0">
                      {" "}
                      <b style={{ marginLeft: "10px" }}>
                        Age : {profile.candidatAge}
                      </b>
                    </p>
                  ) : (
                    <p className="mb-0 age00">
                      <b className="notAvailable">✘ Age Not Available!</b>
                    </p>
                  )}
                </div>
                <div>
        ...
        <div className="col-12 ">
          <div className="row cardColorRowEmbaunch" style={{ height: "49px" }}>
            <div className="col-8 d-flex align-items-center">
              <Link to="#">
                <button className="EmbaucheCardBtn p-0">
        ...
        <div className="card-bodyEmbauch pl-0 " style={{ marginLeft: "5px" }}>
          <div className="pr-0 EmbauchCardChildFonts">
            ...
            <p className="mb-0">
              ...
              <b>
                {" "}
                {profile.candidatLanguages.length
                  ? profile.candidatLanguages.length > 3
                    ? profile.candidatLanguages.slice(0, 3).join(", ") + "..."
                    : profile.candidatLanguages.join(", ")
                  : "✘ No Langues Selected!"}{" "}
              </b>
            </p>
            <p className="mb-0">
              Phone Number:{" "}
              <b>
                {profile.candidatPhone ? profile.candidatPhone : "✘ No Phone!"}
              </b>
            </p>
            <p className="mb-0">
              Facebook URL:{" "}
            ...
            <p className="preCard-Body-p">
              ...
              <b>
                {" "}
                {profile.candidatEmail
                  ? profile.candidatEmail.length > 20
                    ? profile.candidatEmail.slice(0, 22).toLocaleUpperCase() +
                      "..."
                    : profile.candidatEmail.toLocaleUpperCase()
                  : "✘ No Email Provided!"}
              </b>
            </p>
            <h6
              className="todoCardbodyBlue mb-0 my-1"
              style={{
        ...
        <div className="box-purple">
          <p className="mb-0 workAt">
            Works At :{" "}
            {profile.candidatCurrentWork[0].workingFor
              ? profile.candidatCurrentWork[0].workingFor.length > 20
                ? profile.candidatCurrentWork[0].workingFor
                    .slice(0, 25)
                    .toLocaleUpperCase() + "...."
                : profile.candidatCurrentWork[0].workingFor.toLocaleUpperCase()
              : "✘ No Working"}
          </p>
          <p className="mb-0 workAt">
            Since :{" "}
